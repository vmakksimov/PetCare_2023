"""
Django settings for PetCare_2023 project.
...
SECRET_KEY = 'django-insecure-2(*crdwwq@7_hvzn(67(_%ga8&=p(7tg-d@o27^=f=szjn65f)'
...
WSGI_APPLICATION = 'PetCare_2023.wsgi.application'
